...
public class Combat extends Node implements ActionListener
{
    ...
    private Player player, rival_player;
    private int rounds = 0;
    
    private double challenger1_hp, challenger2_hp, monster_hp;
    ...
    public Combat(Player p1, Player p2)
    {
        ...
        dicebutton.addActionListener(new ActionListener(){
            ...
            else
            {
                ...
                power_of_hit = rival_player.getPowerOfHit(diceresult);
                player.decreaseHp(power_of_hit);
            ...
            if(rival_player.hp <= 0)
            {
                ...
                Buff b = new Buff(player);
                combat.dispose();
                player.increaseStat(b.getElement());
            ...
            if( player.hp <= 0)
            {
                ...
                Buff b = new Buff(rival_player);
                combat.dispose();
                rival_player.increaseStat(b.getElement());
                rival_player.increaseCoins();
            }
        ...
        else
        {
            ...
            new Timer(3000, new ActionListener() {
                public void actionPerformed(ActionEvent ae){
                    ...
                    power_of_hit = monster.getPowerOfHit(diceresult2);
                    player.decreaseHp(power_of_hit);
                    challenger1_hp = player.hp;
