...
public class Shop extends JFrame implements ActionListener
{
    ...
    public Shop(Player p)
    {
        ...
        for(int i = 0; i < 9; i++)
        {
            flags[i] = CatalogBuff.getElementByNumber(i).getAvailable();
        }
                ...
                if(text.equals("HP") || text.equals("Damage") || text.equals("Critical"))
                {
                    ...
                    else
                    {
                     ...
                     for(int i = 0; i < 9; i++)
                     {
                        ...
                        {
                            CatalogBuff.getElementByNumber(i).setAvailable();
                        }
                     }
                    }
                } 
        ...
        for(int i=0; i<9; i++)
        {
            ...
            if(CatalogBuff.getElementByNumber(i).getAvailable())
            {
